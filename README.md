...
[![发布 v0.4.5](https://img.shields.io/badge/release-v0.4.5-111827)](https://github.com/JahanHe/Shop-ai-reply/releases/tag/v0.4.5)
...
| 系统 | 下载 |
| --- | --- |
| macOS Apple Silicon | [xiaodian-ai-kefu-macos-arm64.dmg](https://github.com/JahanHe/Shop-ai-reply/releases/download/v0.4.5/xiaodian-ai-kefu-macos-arm64.dmg) |
| Windows 安装版 | [xiaodian-ai-kefu-windows-setup.exe](https://github.com/JahanHe/Shop-ai-reply/releases/download/v0.4.5/xiaodian-ai-kefu-windows-setup.exe) |
| Windows 便携版 | [xiaodian-ai-kefu-windows-portable.exe](https://github.com/JahanHe/Shop-ai-reply/releases/download/v0.4.5/xiaodian-ai-kefu-windows-portable.exe) |

- 发布说明：[v0.4.5](docs/release-notes/v0.4.5.md)
...
| 模块 | 当前行为 |
| --- | --- |
| 知识体系 | 明确分为“本地规则库”和“本机知识资料” |
| 外部资料 | 只允许连接、下载和增量同步，生产回复禁止实时查询远端 |
| 本机索引 | 统一检索 knowledge-base、手动知识、参考回复和外部同步缓存 |
| 规则编辑 | 默认紧凑摘要列表，同一时间只展开一条规则 |
| 测试中心 | 统一测试智能路由、规则、动作、AI、本机资料和外部同步资料 |
| 设置归位 | Bot 策略、AI API、外部同步、Webhook 和悬浮窗集中在设置 |
