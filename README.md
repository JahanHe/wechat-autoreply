...
[![Release v0.3.1](https://img.shields.io/badge/release-v0.3.1-111827)](https://github.com/JahanHe/wechat-autoreply/releases/tag/v0.3.1)
...
| 你关心的问题 | 当前答案 |
| --- | --- |
| 下载入口在哪里？ | 在 [GitHub Releases v0.3.1](https://github.com/JahanHe/wechat-autoreply/releases/tag/v0.3.1)，不是 Packages |
...
| 系统 | 下载 |
| --- | --- |
| macOS Apple Silicon | [wechat-autoreply-macos-arm64.dmg](https://github.com/JahanHe/wechat-autoreply/releases/download/v0.3.1/wechat-autoreply-macos-arm64.dmg) |
| Windows 安装版 | [wechat-autoreply-windows-setup.exe](https://github.com/JahanHe/wechat-autoreply/releases/download/v0.3.1/wechat-autoreply-windows-setup.exe) |
| Windows 便携版 | [wechat-autoreply-windows-portable.exe](https://github.com/JahanHe/wechat-autoreply/releases/download/v0.3.1/wechat-autoreply-windows-portable.exe) |

发布说明：[docs/release-notes/v0.3.1.md](docs/release-notes/v0.3.1.md)
...
| 查看当前发行版的富文本说明 | [docs/release-notes/v0.3.1.md](docs/release-notes/v0.3.1.md) |
