...
const statuses = [
  ...
  ["api_calling", "调用API", "active", "AI", "正在通过本机回复中转服务请求远方AI API"],
  ["async_api", "异步API", "active", "AI", "后台继续生成详细回复"],
  ["ai_thinking", "AI生成中", "active", "AI", "AI API正在生成回复"],
  ["api_delayed", "AI延迟", "warn", "AI", "超过60秒仍在等待AI API最终回复"],
  ["retrying", "补救中", "active", "AI", "正在调用AI API生成补充回复"],
