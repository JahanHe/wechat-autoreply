...
| `v0.4.4` | 本次发布 | 统一本机回复中转服务和 AI API 术语，新增 ReplyTask、客户记忆、完成度检查、持续补救和规则候选池 |
...
截至 `2026-06-12`，项目已经从“依赖浏览器的自动回复脚本”推进成“可安装、可配置、可观察、可恢复、可继续扩展规则，并且具备发布门禁、开源入口和新版主控台框架的桌面客服工作台”。
